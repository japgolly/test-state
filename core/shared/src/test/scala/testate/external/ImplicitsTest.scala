...
abstract class AbstractTest {
  ...
  implicit def fem: testate.typeclass.ExecutionModel[F]
  ...
  val dsl: testate.dsl.Dsl[F, R, O, S, E]
}
...
abstract class ImplicitsTest1 extends AbstractTest {
  ...
  abstract class Transformers1 {
    implicit val transformer: testate.core.Transformer[F, R, O, S, E, F2, R2, O2, S2, E2]
...
//                  (x: Invariants      [O, S, E]) => x: Invariants        [O2, S2, E2]
  ...
  abstract class Transformers2 {
    implicit val t2: testate.core.Transformer[F2, R2, O2, S2, E2, F, R, O, S, E]
    implicit val t3: testate.core.Transformer[F3, R3, O3, S3, E3, F, R, O, S, E]
